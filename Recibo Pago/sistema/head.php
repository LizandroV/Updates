		...
		<div class="full-width navLateral-body">
			...
			<nav class="full-width">
				<ul class="full-width list-unstyle menu-principal">
					...
					$sql2 = "SELECT b.orden,b.nombre1 FROM master a LEFT JOIN login b on a.idmenu=b.id WHERE a.idcliente='$_SESSION[micodigo]' AND b.idt='0' GROUP by a.idcliente,b.orden,b.nombre1, b.id";
					$sq0 = db_query($sql2);
					...
					?>
						...
						<li class="full-width">
							...
							<ul class="full-width menu-principal sub-menu-options">
								...
								$sql2 = "SELECT b.script,b.nombre1 FROM master a LEFT JOIN login b on a.idmenu=b.id WHERE a.idcliente='$_SESSION[micodigo]' AND b.idt='$rows[orden]' group by b.script,b.nombre1";
								$sq = db_query($sql2);
