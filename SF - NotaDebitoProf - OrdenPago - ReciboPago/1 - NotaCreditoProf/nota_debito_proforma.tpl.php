...
<body onLoad="llamadaCodNotaDebito_prof();">
        ...
        <td valign="top">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" class="borderTabla1" align="center">
            <tr background="images/bg_topbar.gif">
              <td width="920" height="23" colspan="2" background="images/bg_topbar.gif">&nbsp;<img src="images/n_nota_de_debito.png" alt="" width="16" height="16" align="absmiddle">
                <strong> NOTA DE DEBITO DE PROFORMA</strong>
                <strong><span id="nota_debito_prof">N.D. N&ordm;</span></strong>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="<?= $GLOBALS[color][18] ?>">
                  <tr>
                    ...
                    <td height="23" valign="middle">: <label>
                        <select name="codNegocio" class="smalltext" id="codNegocio">
                          <?php
                    ...
                    <td height="23" valign="middle">: <span>
                        ...
                        $sql_entidad = "	select	MotCod, codigoSunat+' '+ MotNom MotNom
                          from	motivo
                          where	estado=1 and nota='debito'
                          order by MotNom asc ";
                  ...
                  <tr>
                    ...
                    <td height="23" valign="middle">:&nbsp;<input name="numero_nota" style="text-align:right;" type="text" id="numero_nota" size="13">&nbsp;<span style="color:#F00; font-size:9px;">N.D. Física. Ej.: 005-00158571 | N.D. Elec. Ej. F002-3</span></td>
                  </tr>
                  <tr>
            ...
            <tr>
              <td height="20" align="center">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="borderTabla1" align="center" bgcolor="<?= $GLOBALS[color][18] ?>">
                  ...
                  <tr>
                    <td align="center" height="15"><button name="boton" id="bus_ingreso" onClick="buscar_datos_orden_proforma_nd()" class="button2" type="button"><img width="15" height="16" src="images/b_view.png" align="absmiddle">&nbsp;Buscar</button>&nbsp;&nbsp;
                      <!-- <button name="boton" id="model_nd" disabled onClick="print_nd_web()" class="button2" type="button"><img width="15" height="16" src="images/text.gif" align="absmiddle">&nbsp;Fisico</button>&nbsp;&nbsp; -->
                      <button name="btn_ndE" id="btn_ndE" onClick="imprimir_ndp()" class="button2" type="button"><img width="15" height="16" src="images/text.gif" align="absmiddle">&nbsp;Imprimir</button>&nbsp;&nbsp;
                      <button name="boton" id="nuevo" onClick="nuevo_documento_nd_prof()" class="button2" type="button"><img width="15" height="15" src="images/new_docu.png" align="absmiddle">&nbsp;Nuevo Documento</button>&nbsp;&nbsp;
                      <button name="boton" id="item" onClick="insertar_fila_detalle_nota_debito_prof()" class="button2" type="button"><img width="15" height="15" src="images/new_filas.png" align="absmiddle">&nbsp;Nuevo Item</button>&nbsp;&nbsp;
                      <button name="boton" id="guardar" onClick="registrar_nota_debito_prof()" class="button2" type="button"><img width="15" height="15" src="images/btn_guardar.png" align="absmiddle">&nbsp;Guardar Documento</button>&nbsp;&nbsp;
                      <button name="boton" disabled id="eliorden" onClick="eliminar_nota_nd_prof()" class="button2" type="button"><img width="15" height="15" src="images/del_orden.png" align="absmiddle">&nbsp;Eliminar Nota</button>
                    </td>
                  </tr>
                  <tr>
                    <td height="8"><!--&nbsp; --></td>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" class="borderTabla1" align="center">
            <tr width=100%>
              <td>
                ...
                <div style="width:100%; overflow:auto; height:120px;" id="detalle_orden_nota_debito">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="<?= $GLOBALS[color][18] ?>">
                  <tr>
                    ...
                    <td width="158" align="center" valign="middle">:
                      <input class="smalltext" name="txt_subtotal" type="text" id="txt_subtotal" style="text-align:right;" value="0" size="10" readonly disabled>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td align="center" valign="middle">:
                      <input name="txt_total" type="text" id="txt_total" style="text-align:right;" value="0" size="10" class="smalltext" readonly disabled>
                    </td>
                  ...
                  <tr>
                    <td height="22" align="left" valign="middle">&nbsp;</td>
                    <td valign="middle">&nbsp;</td>
                    <td align="center" valign="middle"><input name="txt_parametro_cambio" type="text" id="txt_parametro_cambio" value="" size="4" readonly disabled></td>
                    ...
                    <td align="center" valign="middle">:
                      <label>
                        <input type="text" name="monto_al_cambio" style="text-align:right;" readonly disabled class="smalltext" size="10" id="monto_al_cambio">
                      </label>
                    </td>
                  </tr>
                  <tr>
            ...
            <tr width="100%">
              <td>
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td background="images/fhbg.gif" height="26" colspan="7">&nbsp;<img src="images/b_search.png" alt="" width="14" height="16" align="absmiddle"><strong> B&Uacute;SQUEDA DE NOTAS DE DEBITO POR NEGOCIO</strong></td>
                  </tr>
                  <tr bgcolor="<?= $GLOBALS[color][18] ?>">
                    ...
                    <td colspan="3" valign="middle">: <label>
                        <select class="smalltext" name="cmbcodobra" id="cmbcodobra" onChange="">
                          ...
                          ?>
                        </select></label>&nbsp;&nbsp;<button name="boton" id="car" onClick="buscar_ordenes_nd_prof()" class="button2" type="button">Cargar</button></td>
                    <td width="162" rowspan="3" valign="middle"><button name="boton" id="verorden" disabled onClick="ver_orden_nd_prof()" class="button2" type="button"><img width="15" height="16" src="images/template.gif" align="absmiddle">&nbsp;Ver Orden</button></td>
                    <td width="234" rowspan="3" valign="middle"><button name="boton" id="editorden" disabled onClick="editar_orden_nd_prof()" class="button2" type="button"><img width="15" height="16" src="images/img/b_edit.png" align="absmiddle">&nbsp;Editar Orden</button></td>
                  </tr>
                  <tr bgcolor="<?= $GLOBALS[color][18] ?>">
                  ...
                  <tr bgcolor="<?= $GLOBALS[color][18] ?>">
                    <td height="23"><img src="images/dhtmlgoodies_minus.gif" alt="" width="18" height="13"> Código Nota Débito</td>
                    <td colspan="3" valign="middle">: <label>
                        <select name="cmbordenes" id="cmbordenes" onChange="activar_verorden_nd(this.value)" style="width:200px;">
